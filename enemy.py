...
class Enemy(ABC):
    def __init__(self, screen, xSpeed, ySpeed, startCoords):
        ...
        self.xSpeed = xSpeed
        self.ySpeed = ySpeed
        self.Rt = pg.draw.circle(self.screen, '#00ffffff', startCoords, 18)

    def draw(self):
        self.Rt = pg.draw.circle(self.screen, '#0000ff', self.Rt.center, 18)
        pg.draw.circle(self.screen, '#000000', self.Rt.center, 18, 8)
